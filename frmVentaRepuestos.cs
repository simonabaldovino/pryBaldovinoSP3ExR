...
namespace pryBaldovinoSP3ExR
{
    public partial class frmVentaRepuestos : Form
    {
        ...
        private void btnCargar_Click(object sender, EventArgs e)
        {
            ...
            // Carga en la matriz
            matRepuestos[filaActual, 0] = cboMarca.SelectedItem.ToString();
            matRepuestos[filaActual, 1] = cboOrigen.SelectedItem.ToString();
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            string marca = cboMarcaC.SelectedItem.ToString();
            ...
            for (int i = 0; i < filaActual; i++)
            {
                ...
                {
                    dgvDatos.Rows.Add(matRepuestos[i, 2], matRepuestos[i, 3], $"${matRepuestos[i, 4]}");
                    hayDatos = true;
                }
            }
